...
export type WizardKind =
  ...
  | "con_lookahead_plan"
  | "con_permit_to_work"
  // Bid / RFP / pursuit lifecycle
  | "con_bid_no_bid"
  | "con_rfp_response_plan"
  | "con_executive_summary"
  | "con_technical_proposal_section"
  | "con_clarification_log"
  | "con_estimate_basis"
  | "con_pqq_response"
  | "con_cover_letter_bid"
  | "con_post_tender_clarifications"
  | "con_win_loss_review"
  // Project lifecycle
  | "con_preconstruction_plan"
  | "con_mobilisation_plan"
  | "con_project_execution_plan"
  | "con_stage_gate_review"
  | "con_closeout_report"
  | "ps_sow_draft"
